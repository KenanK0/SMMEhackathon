...
import { Text, SafeAreaView, StyleSheet, ScrollView, View, TouchableOpacity, Animated, Alert, Button, Image } from "react-native";
    ...
    <SafeAreaView style={styles.area} >
      <ScrollView nestedScrollEnabled={true} showsVerticalScrollIndicator={false} >
        ...
        <View style={{marginTop:20}} >
          <Image style={{width:100,height:100,alignSelf:"center",borderRadius:200 }} source={require("../../assets/icon.png")} />
          <Text style={{fontWeight:"bold",fontSize:24,color:"#fff",alignSelf:"center",paddingTop:2}} >Pocket BA </Text>
        </View>
        ...
        <View style={styles.form} >
          ...
          <Input placeholder="Confirm Password"
            rightIcon={<MaterialCommunityIcons name="lock-open-check" size={24} color="black" />}
            onChangeText={ value => setData({...data, "email":value}) }
          />

          <Input placeholder="location"
            rightIcon={<MaterialIcons name="location-on" size={24} color="black" />}
            onChangeText={ value => setData({...data, "email":value}) }
          />
